...
use App\models\school\schoolInfoModel;
use App\models\teachers\teacherInfoModel;
use Carbon\Carbon;
...
class eventController extends Controller
{
    ...
    public function oponInterviewForTeacher($teacher_id, $interview_id)
    {
        ...
        {
            return view('error.invalid_user');
        }
    ...
    public function openEventPage($interview=null, $teacher_info, $school_info)
    {
        return view('events.eventsPage', compact('interview', 'teacher_info','school_info'));
    }
