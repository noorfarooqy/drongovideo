<template>
    <div class="panel layout-panel layout-panel-center panel-htop" style="width: 1495px; left: 54px; top: 64px;"><div id="center" data-options="region:'center'" style="width: 1492.99px; height: 481.995px;" title="" class="panel-body panel-body-noheader layout-body">
   <div id="stage">
      <div class="canvas-container" style="width: 1492.99px; height: 484px; position: relative; user-select: none;"><canvas id="canvasBoard" class="lower-canvas" width="1492" height="484" style="position: absolute; width: 1492.99px; height: 484px; left: 0px; top: 0px; user-select: none;"></canvas><canvas class="upper-canvas " width="1492" height="484" style="position: absolute; width: 1492.99px; height: 484px; left: 0px; top: 0px; user-select: none; cursor: crosshair;"></canvas></div>
      <!--WebRTC block -->
   ...
   <div class="wr-rgt">
      <div class="wr-rgt-cont">
        ...
        <!-- code of background color picker -->
         <div class="subProperties left-meni-slide" id="bgColorpick" style="min-height: 306px; max-height: 100%; display: none;">
         ...
         <!-- code of patterns -->
         <div class="subProperties left-meni-slide" id="bgPattern" style="min-height: 312px; max-height: 100%; display: none;">
         ...
         <!-- code of pencil -->
         <div class="subProperties left-meni-slide" id="penEdit" style="min-height: 345px; max-height: 100%; display: none;">  
           ...
           <div class="sub-tools">          
             ...
             <input id="lineSlide" value="2" class="numberspinner-f numberbox-f textbox-f spinner-f" textboxname="lineSlide" numberboxname="lineSlide" spinnername="lineSlide" style="display: none;"><span class="textbox numberbox spinner" style="width: 1.00481px;"><span class="textbox-addon textbox-addon-right" style="right: 0px; top: 0px;"><a href="javascript:;" class="textbox-icon spinner-arrow" icon-index="0" tabindex="-1" style="width: 18px; height: 33.9976px;"><a href="javascript:;" class="spinner-arrow-up" tabindex="-1"></a><a href="javascript:;" class="spinner-arrow-down" tabindex="-1"></a></a></span><input id="_easyui_textbox_input6" type="text" class="textbox-text validatebox-text" autocomplete="off" tabindex="" data-original-title="" title="" placeholder="" style="margin: 0px 17.9928px 0px 0px; padding-top: 0px; padding-bottom: 0px; height: 33.9976px; line-height: 33.9976px; width: 15.9952px;"><input type="hidden" class="textbox-value" name="lineSlide" value="2"></span>
           </div>        
         </div>
         <!-- end of code for pencil-->
         
         <!-- code for eraser--> 
         <div class="subProperties left-meni-slide" id="eraseOptions" style="min-height: 43px; max-height: 100%; display: none;">
           <div class="icon-curve icon-eraseoption"></div>
           <div class="sub-tools">      
             <input id="eraserSlide" value="2" class="numberspinner-f numberbox-f textbox-f spinner-f" textboxname="eraserSlide" numberboxname="eraserSlide" spinnername="eraserSlide" style="display: none;"><span class="textbox numberbox spinner" style="width: 1.00481px;"><span class="textbox-addon textbox-addon-right" style="right: 0px; top: 0px;"><a href="javascript:;" class="textbox-icon spinner-arrow" icon-index="0" tabindex="-1" style="width: 18px; height: 33.9976px;"><a href="javascript:;" class="spinner-arrow-up" tabindex="-1"></a><a href="javascript:;" class="spinner-arrow-down" tabindex="-1"></a></a></span><input id="_easyui_textbox_input8" type="text" class="textbox-text validatebox-text" autocomplete="off" tabindex="" data-original-title="" title="" placeholder="" style="margin: 0px 17.9928px 0px 0px; padding-top: 0px; padding-bottom: 0px; height: 33.9976px; line-height: 33.9976px; width: 15.9952px;"><input type="hidden" class="textbox-value" name="eraserSlide" value="2"></span>
           </div>
         </div>
         <!-- end of code for eraser-->
         
         <!-- code of shapes -->
         <div class="subProperties left-meni-slide" id="shapeOptions" style="min-height: 351px; max-height: 100%; display: none;">
         ...
         <!-- HTML of Text -->
         <div id="textOptions" class="subProperties left-meni-slide" style="min-height: 135px; max-height: 100%; display: none;">
         ...
         <!-- HTML of Image -->
         <div id="imageOptions" class="subProperties left-meni-slide" style="min-height: 91px; max-height: 100%; display: none;">
         ...
         <!-- code of download -->
         <div class="subProperties left-meni-slide" id="downloadOptions" style="min-height: 145px; max-height: 100%; display: none;">
   ...
   <!-- code of Help -->      
   <div class="subProperties helpclas" id="helpOptions" style="display: none;">
      <div class="sub-tools" style="right:0px!important; background:#fff!important; margin:0px!important;">  
         <div class="easyui-accordion accordion" style="width:242px;"> 
            <div class="panel panel-htop" style="width: 242px;"><div class="panel-header accordion-header" style="height: 30px; width: 242px;"><div class="panel-title">Background</div><div class="panel-tool"><a href="javascript:;" class="panel-tool-collapse panel-tool-expand" style="display: none;"></a><a href="javascript:;" class="accordion-collapse accordion-expand"></a></div></div><div title="" data-options="iconCls:''" style="overflow: auto; padding: 0px; width: 242px; display: none;" class="panel-body accordion-body" id="">
            ...
            <div class="panel panel-htop" style="width: 242px;"><div class="panel-header accordion-header" style="height: 30px; width: 242px;"><div class="panel-title">Pencil</div><div class="panel-tool"><a href="javascript:;" class="panel-tool-collapse panel-tool-expand" style="display: none;"></a><a href="javascript:;" class="accordion-collapse accordion-expand"></a></div></div><div title="" data-options="iconCls:''" style="overflow: auto; padding: 0px; display: none; width: 242px;" class="panel-body accordion-body" id="">
               <div class="help-acc"><a class="ancHelp" href="javascript:void(0)" alt="how-to-use-pencil-width">How to use Pencil Tool</a></div>        
            </div></div>
            <div class="panel panel-htop" style="width: 242px;"><div class="panel-header accordion-header" style="height: 30px; width: 242px;"><div class="panel-title">Erase</div><div class="panel-tool"><a href="javascript:;" class="panel-tool-collapse panel-tool-expand" style="display: none;"></a><a href="javascript:;" class="accordion-collapse accordion-expand"></a></div></div><div title="" data-options="iconCls:''" style="overflow: auto; padding: 0px; display: none; width: 242px;" class="panel-body accordion-body" id="">
               <div class="help-acc"><a class="ancHelp" href="javascript:void(0)" alt="how-to-use-erase">How to use Erase Tool</a></div>        
            </div></div>
            <div class="panel panel-htop" style="width: 242px;"><div class="panel-header accordion-header" style="height: 30px; width: 242px;"><div class="panel-title">Shape</div><div class="panel-tool"><a href="javascript:;" class="panel-tool-collapse panel-tool-expand" style="display: none;"></a><a href="javascript:;" class="accordion-collapse accordion-expand"></a></div></div><div title="" data-options="iconCls:''" style="overflow: auto; padding: 0px; display: none; width: 242px;" class="panel-body accordion-body" id="">
            ...
            <div class="panel panel-htop" style="width: 242px;"><div class="panel-header accordion-header" style="height: 30px; width: 242px;"><div class="panel-title">Text</div><div class="panel-tool"><a href="javascript:;" class="panel-tool-collapse panel-tool-expand" style="display: none;"></a><a href="javascript:;" class="accordion-collapse accordion-expand"></a></div></div><div title="" data-options="iconCls:''" style="overflow: auto; padding: 0px; display: none; width: 242px;" class="panel-body accordion-body" id="">
            ...
            <div class="panel panel-htop" style="width: 242px;"><div class="panel-header accordion-header" style="height: 30px; width: 242px;"><div class="panel-title">Image</div><div class="panel-tool"><a href="javascript:;" class="panel-tool-collapse panel-tool-expand" style="display: none;"></a><a href="javascript:;" class="accordion-collapse accordion-expand"></a></div></div><div title="" data-options="iconCls:''" style="overflow: auto; padding: 0px; display: none; width: 242px;" class="panel-body accordion-body" id="">
               <div class="help-acc"><a class="ancHelp" href="javascript:void(0)" alt="how-to-use-image-addremove">How to use Image Tool</a></div>        
            </div></div>
            <div class="panel panel-htop panel-last" style="width: 242px;"><div class="panel-header accordion-header" style="height: 30px; width: 242px;"><div class="panel-title">Upload/Download</div><div class="panel-tool"><a href="javascript:;" class="panel-tool-collapse panel-tool-expand" style="display: none;"></a><a href="javascript:;" class="accordion-collapse accordion-expand"></a></div></div><div title="" data-options="iconCls:''" style="overflow: auto; padding: 0px; display: none; width: 242px;" class="panel-body accordion-body" id="">
